...
- [x] **Estudo PGFN (2026-05-09):** consolidado diagnóstico técnico da camada PGFN (`PGFN_CONSULTAR`/`DIVIDA_ATIVA`), riscos multi-empresa e plano de hardening em `integrations/serpro.md`.
