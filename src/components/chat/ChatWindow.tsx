            ...
            {chat.isRegistered && chat.leadStatus && (
              <div className="flex flex-col items-start gap-1">
                ...
                {chat.leadNeedsAttendant && (
                  <span className={`flex items-center gap-1 text-[10px] px-1 rounded border font-bold uppercase tracking-wider ${chat.leadAttendantRequestedAt && currentTimestamp && new Date(chat.leadAttendantRequestedAt).getTime() < currentTimestamp - 3600000
