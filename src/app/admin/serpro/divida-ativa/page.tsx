  ...
  const handleConsultar = async () => {
    ...
    try {
      const res = await fetch('/api/serpro', {
        ...
        body: JSON.stringify({ 
          cnpj, 
          service: 'DIVIDA_ATIVA',
          ano // Envia ano se o usuário preencher, embora Dívida Ativa geralmente retorne tudo
        }),
      });
  ...
  return (
    <div className="space-y-6 h-full p-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Consulta Dívida Ativa</h1>
      </div>
        ...
        (() => {
          ...
          return (
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-800">
                <DataViewer data={primaryData} title="Resultado da Consulta" />
