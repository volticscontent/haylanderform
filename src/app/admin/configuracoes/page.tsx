...
import { getSystemSettings, updateSystemSetting, uploadSystemSettingFile, updateSettingBots, type SystemSetting } from './actions';
import { Upload, File as FileIcon, Check, Loader2, CheckCircle2 } from 'lucide-react';
...
function MediaCard({ setting, onUpdate, onBotChange }: { setting: SystemSetting, onUpdate: () => void, onBotChange: (k: string, b: string, c: boolean) => void }) {
